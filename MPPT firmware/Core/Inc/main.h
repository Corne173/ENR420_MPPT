...
{
  FAULT_NONE = 0,
  FAULT_ADC1_CALIBRATION,
  FAULT_ADC2_CALIBRATION,
  FAULT_ADC1_DMA_START,
  FAULT_ADC2_DMA_START,
  FAULT_ADC_TRIGGER_START,
  FAULT_ADC_TRIGGER_LOST,
  FAULT_ADC1_FIRST_BUFFER,
  FAULT_ADC2_FIRST_BUFFER,
  FAULT_ADC_BOTH_FIRST_BUFFER,
  FAULT_ADC1_OVERRUN,
  FAULT_ADC2_OVERRUN,
  FAULT_ADC1_DMA_TRANSFER,
  FAULT_ADC2_DMA_TRANSFER,
  FAULT_ADC1_INTERNAL,
  FAULT_ADC2_INTERNAL,
  FAULT_ADC1_STALE,
  FAULT_ADC2_STALE,
